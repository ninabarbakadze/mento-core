...
interface IPairManager {
    struct Pair {
        ...
        // FixidityLib.Fraction collateralBucketFraction; // TODO: Decide on fixed point math lib or continue using Fixidity 🫠
     ...
     */
    event PairCreated(address indexed stableAsset, address indexed collateralAsset, address indexed mentoExchange);
     ...
     * @param mentoExchange The address of the Mento exchange.
     */
    event PairDestroyed(address indexed stableAsset, address indexed collateralAsset, address indexed mentoExchange);
